...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_dashdash__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</pre><h1><a class="anchor" id="autotoc_md9042"></a>
Usage</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md9043"></a>
Longer Example</h1>
<p>A more realistic <a href="./examples/foo.js">starter script "foo.js"</a> is as follows. This also shows using <code><a class="el" href="namespacedotenv_1_1cli.html#a9976e22aa56642d2065b65e241fd4ad2">parser.help()</a></code> for formatted option help.</p>
...
</div><!-- fragment --><p>With the <code>includeEnv: true</code> config to <code><a class="el" href="namespacedotenv_1_1cli.html#a9976e22aa56642d2065b65e241fd4ad2">parser.help()</a></code> the environment variable can also be included in <b>help output</b>: </p><pre class="fragment">usage: node foo.js [OPTIONS]
options:
...
</pre><h1><a class="anchor" id="autotoc_md9045"></a>
Bash completion</h1>
...
<li><code>help</code> (String). Optional. Used for <code><a class="el" href="namespacedotenv_1_1cli.html#a9976e22aa56642d2065b65e241fd4ad2">parser.help()</a></code> output.</li>
...
<li><code>helpWrap</code> (Boolean). Optional, default true. Set this to <code>false</code> to have that option's <code>help</code> <em>not</em> be text wrapped in <code>&lt;parser&gt;.<a class="el" href="namespacedotenv_1_1cli.html#a9976e22aa56642d2065b65e241fd4ad2">help()</a></code> output.</li>

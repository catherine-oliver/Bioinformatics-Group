...
<title>Vaccine Dashboard: lru cache</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_lru_cache__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h1><a class="anchor" id="autotoc_md20068"></a>
Installation:</h1>
<div class="fragment"><div class="line">npm install lru-cache --save</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md20069"></a>
Usage:</h1>
...
<li><code>noDisposeOnSet</code> By default, if you set a <code>dispose()</code> method, then it'll be called whenever a <code><a class="el" href="namespacepy_1_1__builtin.html#a2b2dc1c23346592e3b7dd26be6125f6c">set()</a></code> operation overwrites an existing key. If you set this option, <code>dispose()</code> will only be called when a key falls out of the cache, not when it is overwritten.</li>
...
<h1><a class="anchor" id="autotoc_md20071"></a>
API</h1>
<ul>
...
<p class="startli">If the key is not found, <code><a class="el" href="namespacedotenv_1_1cli.html#aaa27b896ba6c8cb56b53bc930fb1b429">get()</a></code> will return <code>undefined</code>.</p>
...
<li><p class="startli"><code><a class="el" href="namespacepip_1_1__vendor_1_1msgpack.html#a56c20177cf5513014f1df148a0b227f2">dump()</a></code></p>
...
<p class="startli">Loads another cache entries array, obtained with <code><a class="el" href="namespacepip_1_1__vendor_1_1msgpack.html#a56c20177cf5513014f1df148a0b227f2">sourceCache.dump()</a></code>, into the cache. The destination cache is reset before loading new entries</p>
</li>

...
<title>Vaccine Dashboard: Acorn</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_jest_environment_jsdom_node_modules_acorn__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md16586"></a>
Interface</h1>
...
<ul>
<li><p class="startli"><b>ecmaVersion</b>: Indicates the ECMAScript version to parse. Must be either 3, 5, 6 (or 2015), 7 (2016), 8 (2017), 9 (2018), 10 (2019), 11 (2020), 12 (2021, partial support), 13 (2022, partial support) or <code>"latest"</code> (the latest the library supports). This influences support for strict mode, the set of reserved words, and support for new syntax features.</p>
...
<h2><a class="anchor" id="autotoc_md16587"></a>

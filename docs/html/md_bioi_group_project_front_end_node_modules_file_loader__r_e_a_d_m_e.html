...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_file_loader__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
file-loader</h1>
<p>The <code>file-loader</code> resolves <code>import</code>/<code><a class="el" href="namespacepip_1_1__vendor_1_1pkg__resources.html#ad0f72942fbe9e7ab6e8a6441fa6925de">require()</a></code> on a file into a url and emits the file into the output directory.</p>
...
<h4><a class="anchor" id="autotoc_md11928"></a>
&lt;tt&gt;String&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11929"></a>
&lt;tt&gt;Function&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<h4><a class="anchor" id="autotoc_md11931"></a>
&lt;tt&gt;String&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11932"></a>
&lt;tt&gt;Function&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11933"></a>
&lt;tt&gt;publicPath&lt;/tt&gt;</h3>
<p>Type: <code>String|Function</code> Default: <a href="https://webpack.js.org/api/module-variables/#__webpack_public_path__-webpack-specific-"><code>__webpack_public_path__</code></a></p>
<p>Specifies a custom public path for the target file(s).</p>
<h4><a class="anchor" id="autotoc_md11934"></a>
&lt;tt&gt;String&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11935"></a>
&lt;tt&gt;Function&lt;/tt&gt;</h4>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md11939"></a>
&lt;tt&gt;regExp&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md11940"></a>
&lt;tt&gt;esModules&lt;/tt&gt;</h3>
<p>Type: <code>Boolean</code> Default: <code>false</code></p>
<p>By default, <code>file-loader</code> generates JS modules that use the CommonJS syntax. However, there are some cases in which using ES2015 modules is beneficial, like in the case of <a href="https://webpack.js.org/plugins/module-concatenation-plugin/">module concatenation</a> and <a href="https://webpack.js.org/guides/tree-shaking/">tree shaking</a>.</p>
<p><b>webpack.config.js</b></p>
<div class="fragment"><div class="line">module.exports = {</div>
<div class="line">  module: {</div>
<div class="line">    rules: [</div>
...
<div class="line">            loader: &#39;file-loader&#39;,</div>
<div class="line">            options: {</div>
<div class="line">              esModules: true,</div>
<div class="line">            },</div>
<div class="line">          },</div>
<div class="line">        ],</div>
<div class="line">      },</div>
...
<div class="line">  },</div>
<div class="line">};</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11941"></a>
Placeholders</h2>
...
<p>Type: <code>String</code> Default: <code>md5</code></p>
<p>Specifies the hash method to use for hashing the file content.</p>
<h3><a class="anchor" id="autotoc_md11950"></a>
...
<h4><a class="anchor" id="autotoc_md11951"></a>
&lt;tt&gt;digestType&lt;/tt&gt;</h4>
...
<h4><a class="anchor" id="autotoc_md11952"></a>
&lt;tt&gt;hashType&lt;/tt&gt;</h4>
<p>Type: <code>String</code> Default: &lsquo;'md5&rsquo;`</p>
<p>The type of hash that the has function should use. Valid values include: <code>md5</code>, <code>sha1</code>, <code>sha256</code>, and <code>sha512</code>.</p>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md11960"></a>
Contributing</h2>

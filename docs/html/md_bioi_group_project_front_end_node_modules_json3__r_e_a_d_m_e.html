...
<title>Vaccine Dashboard: 🚨 Unmaintained 🚨</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_json3__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h1><a class="anchor" id="autotoc_md19527"></a>
JSON 3</h1>
...
<h2><a class="anchor" id="autotoc_md19528"></a>
About</h2>
...
<p>JSON 3 exposes two functions: <code>stringify()</code> for <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/JSON/stringify">serializing</a> a JavaScript value to JSON, and <code><a class="el" href="namespacepackaging_1_1version.html#a9ac4c2515e799003b63bd7dae516b0b3">parse()</a></code> for <a href="https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/JSON/parse">producing</a> a JavaScript value from a JSON source string. The JSON 3 parser uses recursive descent instead of <code>eval</code> and regular expressions, which makes it slower on older platforms compared to <a href="http://json.org/js">JSON 2</a>. The functions behave exactly as described in the ECMAScript spec, <b>except</b> for the date serialization discrepancy noted below.</p>
...
<h1><a class="anchor" id="autotoc_md19530"></a>
Usage</h1>
...
&lt;/script&gt;
</pre><p> <b>When used in a web browser</b>, JSON 3 exposes an additional <code>JSON3</code> object containing the <code>noConflict()</code> and <code>runInContext()</code> functions, as well as aliases to the <code>stringify()</code> and <code><a class="el" href="namespacepackaging_1_1version.html#a9ac4c2515e799003b63bd7dae516b0b3">parse()</a></code> functions.</p>
...
JSON3.parse("[1, 2, 3]");
// =&gt; [1, 2, 3]
</pre> <h2><a class="anchor" id="autotoc_md19535"></a>
JavaScript Engines</h2>
<pre class="fragment">load("path/to/json3.js");
JSON.stringify({"Hello": 123, "Good-bye": 456}, ["Hello"], "\t");
// =&gt; '{\n\t"Hello": 123\n}'
</pre> <h1><a class="anchor" id="autotoc_md19536"></a>
Compatibility</h1>
...
<h2><a class="anchor" id="autotoc_md19538"></a>
CommonJS Environments</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19540"></a>

...
<title>Vaccine Dashboard: Note: pending imminent deprecation</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_figgy_pudding__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<li>transparent key access like normal keys, through a Proxy. No need <a class="el" href="namespacedotenv_1_1cli.html#aaa27b896ba6c8cb56b53bc930fb1b429">for&lt;tt&gt;.get()</a>!</li>
...
<h3><a class="anchor" id="autotoc_md11805"></a>
API</h3>
<h4><a class="anchor" id="autotoc_md11806"></a>
...
<p><a class="anchor" id="autotoc_md11807"></a> </p><h5>Example</h5>
...
<div class="line">  cache: {}</div>
<div class="line">})</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11808"></a>
...
<p>Each provider can be either a plain object, a <code>Map</code>-like object (that is, one with a <code>.<a class="el" href="namespacedotenv_1_1cli.html#aaa27b896ba6c8cb56b53bc930fb1b429">get()</a></code> method) or another figgyPudding <code>Opts</code> object.</p>
...
<p><a class="anchor" id="autotoc_md11809"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11810"></a>
&lt;a name="opts-get"&gt;&lt;/a&gt; &lt;tt&gt;&gt; opts.get(key) -&gt; Value&lt;/tt&gt;</h4>
<p>Gets a value from the options object.</p>
<p><a class="anchor" id="autotoc_md11811"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11812"></a>
...
<p><a class="anchor" id="autotoc_md11813"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11814"></a>
...
<p><a class="anchor" id="autotoc_md11815"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1})</div>
<div class="line">opts.toJSON() // {x: 1}</div>
<div class="line">JSON.stringify(opts) // &#39;{&quot;x&quot;:1}&#39;</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11816"></a>
...
<p><a class="anchor" id="autotoc_md11817"></a> </p><h5>Example</h5>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11818"></a>
...
<p><a class="anchor" id="autotoc_md11819"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
<div class="line">[...opts({x: 1, y: 2}).entries()] // [[&#39;x&#39;, 1], [&#39;y&#39;, 2]]</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11820"></a>
...
<p><a class="anchor" id="autotoc_md11821"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
...
<div class="line">}</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11822"></a>
...
<p><a class="anchor" id="autotoc_md11823"></a> </p><h5>Example</h5>
<div class="fragment"><div class="line">const opts = MyOpts({x: 1, y: 2})</div>
<div class="line">[...opts({x: 1, y: 2}).keys()] // [&#39;x&#39;, &#39;y&#39;]</div>
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md11824"></a>
...
<p><a class="anchor" id="autotoc_md11825"></a> </p><h5>Example</h5>

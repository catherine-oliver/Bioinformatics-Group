...
<title>Vaccine Dashboard: gensync</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_gensync__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h4><a class="anchor" id="autotoc_md12471"></a>
Example</h4>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12472"></a>
...
<h3><a class="anchor" id="autotoc_md12473"></a>
Example</h3>
...
<div class="line">  ]);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12474"></a>
...
<h3><a class="anchor" id="autotoc_md12475"></a>
Example</h3>
<div class="fragment"><div class="line">const loadFiles = gensync(function* () {</div>

...
<title>Vaccine Dashboard: compression</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_compression__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md7540"></a>
API</h1>
<div class="fragment"><div class="line">var compression = require(&#39;compression&#39;)</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md7541"></a>
...
<h3><a class="anchor" id="autotoc_md7542"></a>
Options</h3>
...
<h4><a class="anchor" id="autotoc_md7543"></a>
chunkSize</h4>
...
<h4><a class="anchor" id="autotoc_md7545"></a>
level</h4>
...
<h4><a class="anchor" id="autotoc_md7546"></a>
memLevel</h4>
...
<p><b>Note</b> in the list above, <code>zlib</code> is from &lsquo;zlib = require('zlib&rsquo;)`.</p>
<h4><a class="anchor" id="autotoc_md7548"></a>
threshold</h4>
...
<p>See <a href="http://nodejs.org/api/zlib.html#zlib_memory_usage_tuning">Node.js documentation</a> regarding the usage.</p>
<h3><a class="anchor" id="autotoc_md7550"></a>
.filter</h3>
...
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md7551"></a>
res.flush</h2>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md7554"></a>

...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_queue_microtask__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><h2><a class="anchor" id="autotoc_md25688"></a>
...
<li>Fallback to <code><a class="el" href="namespace__pytest_1_1monkeypatch.html#a0d08a2bfc38e307a55c8d26dba9e89dc">Promise.resolve()</a>.then(fn)</code> in Node.js 10 and earlier, and old browsers (same performance as <code>queueMicrotask</code>)</li>
</ul>
</li>
</ul>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md25690"></a>
usage</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md25691"></a>
...
<p>The code <code>queueMicrotask(fn)</code> is equivalent to the code <code><a class="el" href="namespace__pytest_1_1monkeypatch.html#a0d08a2bfc38e307a55c8d26dba9e89dc">Promise.resolve()</a>.then(fn)</code>. It is also very similar to <a href="https://nodejs.org/api/process.html#process_process_nexttick_callback_args"><code>process.nextTick(fn)</code></a> in Node.</p>
...
API</h1>
<h2><a class="anchor" id="autotoc_md25698"></a>

...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_jsdom__changelog.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="contents">
<div class="textblock"><h2><a class="anchor" id="autotoc_md18933"></a>
15.2.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18934"></a>
15.2.0</h2>
<ul>
<li>Added basic style inheritance in <code>getComputedStyle()</code> for the &lsquo;'visibility&rsquo;<code>property. This sets the foundation for further work on inheritance, cascading, and specificity. (eps1lon)</code></li>
<li><code>Added</code>shadowRoot.activeElement&lt;tt&gt;.</li>
<li>Addedreadystatechange<code>events during document loading.</code></li>
<li><code>Added a stub for</code>form.requestSubmit()<code>, to match our existing stub for</code>form.submit()<code>.</code></li>
<li><code>Changed</code>el.tabIndex&lt;tt&gt;'s default value, when notabindex=""<code>attribute was set, to reflect the updated specification.</code></li>
<li><code>Changed the exception thrown by</code>el.attachShadow()<code>on something that's already a shadow host, to reflect the updated specification.</code></li>
<li><code>Fixed the validation logic for</code>&lt;input type="range"&gt;<code>.</code></li>
<li><code>Fixed</code>selectEl.value&lt;tt&gt;when no&lt;option&gt;<code>is selected to return the empty string, instead of the value of the first option. (tgohn)</code></li>
<li><code>Fixed various correctness issues with</code>new FormData(formElement)<code>. (brendo)</code></li>
<li><code>Fixed error messages when parsing XML to include the filename, instead of using</code>"undefined"<code>. (papandreou)</code></li>
<li><code>Fixed the logic for reflected properties to not be affected by overwriting of</code>el.getAttributeNS()<code>or</code>el.setAttributeNS()<code>.</code></li>
<li><code>Set</code>canvas<code>as an optional</code><code>peerDependency</code>, which apparently helps with Yarn PnP support.</li>
</ul>
<h2><a class="anchor" id="autotoc_md18935"></a>
15.1.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18936"></a>
15.1.0</h2>
<ul>
...
12.0.0</h2>
<p>This major release brings along our <a href="https://github.com/jsdom/jsdom#loading-subresources">new resource loader API</a>, finally bringing all the capabilities from jsdom v9 to the new (jsdom v10+) API. Thanks very much to <a href="https://github.com/sarvaje">@sarvaje</a> for his work to make this possible!</p>
<p>Breaking changes:</p>
<ul>
...
<h2><a class="anchor" id="autotoc_md18948"></a>
11.10.0</h2>
<ul>
...
11.7.0</h2>
<ul>
<li>Added the boolean return value to <code>DOMTokenList</code>'s <code><a class="el" href="namespacepip_1_1__internal_1_1utils_1_1filesystem.html#a2fc3733bb724a9f843d542afc5a19055">replace()</a></code> method, per the recent spec addition.</li>
...
<li>Fixed some argument conversions in <code>XMLHttpRequest</code>'s <code><a class="el" href="namespacepip_1_1__vendor_1_1distlib_1_1__backport_1_1tarfile.html#a86f867d890099d0ed5f0ce9f3a62a368">open()</a></code> method.</li>
...
<h2><a class="anchor" id="autotoc_md18954"></a>
11.6.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18955"></a>
11.5.1</h2>
...
<h2><a class="anchor" id="autotoc_md18956"></a>
11.4.0</h2>
<p>For this release we'd like to welcome <a href="https://github.com/tmpvar/jsdom/commits?author=Zirro">@Zirro</a> to the core team; his contributions over the course of this year have enhanced jsdom immensely.</p>
<ul>
...
<li>Added the <code><a class="el" href="namespacepip_1_1__vendor_1_1requests.html#a3d60a561f70c88b392abad189d6d53b1">append()</a></code> and <code>prepend()</code> methods to <code>Document</code>, <code>DocumentFragment</code>, and <code>Element</code>. (caub)</li>
<li>Added the <code>before()</code>, <code>after()</code>, and <code><a class="el" href="namespacepip_1_1__vendor_1_1pyparsing.html#a00eff9f138fcf674b55bf2375b6293ce">replaceWith()</a></code> methods to <code>DocumentType</code>, <code>Element</code>, and <code>CharacterData</code>. (caub)</li>
...
<li>Fixed <code><a class="el" href="namespacewerkzeug_1_1exceptions.html#aebbca130bf48b07f939e7e92f3c6a0c5">xhr.abort()</a></code> to clear any set headers.</li>
...
<h2><a class="anchor" id="autotoc_md18957"></a>
11.3.0</h2>
<p>For this release we'd like to formally welcome <a href="https://github.com/tmpvar/jsdom/commits?author=TimothyGu">@TimothyGu</a> to the core team, as a prolific contributor. He will join the illustrious ranks of those who do so much work on jsdom that we no longer note their names in the changelog.</p>
<ul>
...
11.2.0</h2>
<p>This release brings with it a much-awaited infrastructure change, as part of <a href="https://github.com/jsdom/webidl2js/releases/tag/v7.3.0">webidl2js v7.3.0</a> by the ever-amazing TimothyGu: jsdom can now generate spec-compliant versions of classes that have "`Proxy`-like" behavior, i.e. allow getting or setting keys in unusual ways. This enables a number of improvements, also by TimothyGu:</p>
<ul>
...
<ul>
<li>Added no-op APIs <code><a class="el" href="namespaceclick_1_1termui.html#ab1b5715e423a15f497d90ddb25c74134">document.clear()</a></code>, <code>document.captureEvents()</code>, <code>document.releaseEvents()</code>, <code>window.external.AddSearchProvider()</code>, and <code>window.external.IsSearchProviderInstalled()</code>. (Zirro)</li>
...
<li>Improved <code>XMLHttpRequest</code> and <code>FileReader</code> behavior, mainly around event handlers, <code><a class="el" href="namespacewerkzeug_1_1exceptions.html#aebbca130bf48b07f939e7e92f3c6a0c5">abort()</a></code>, and network errors.</li>
...
<li>Fixed <code><a class="el" href="namespacewerkzeug_1_1exceptions.html#aebbca130bf48b07f939e7e92f3c6a0c5">fileReader.abort()</a></code> to terminate ongoing reads properly.</li>
...
<li>Updated <code><a class="el" href="namespacepip_1_1__internal_1_1utils_1_1filesystem.html#a2fc3733bb724a9f843d542afc5a19055">tokenList.replace()</a></code> edge-case behavior.</li>
...
<li>Added <code>Symbol.toStringTag</code> to all web platform classes, so that now <code><a class="el" href="namespacecffi_1_1pkgconfig.html#a661f96826a5e2380b8cd105a3dadc503">Object.prototype.toString.call()</a></code> works as expected on jsdom objects.</li>
...
<li>Fixed an uncaught exception that occurred if you called <code><a class="el" href="namespacewerkzeug_1_1exceptions.html#aebbca130bf48b07f939e7e92f3c6a0c5">xhr.abort()</a></code> during a <code>readystatechange</code> event.</li>
</ul>
...
<ul>
<li><b>Removed support for Node.js v4 and v5</b>, as we have started using new JavaScript features only supported in Node.js v6 onwards.</li>
<li><b>Changed the <code>omitJsdomErrors</code> option to <code>omitJSDOMErrors</code></b>, for consistency <a href="https://w3ctag.github.io/design-principles/#casing-rules">with web platform APIs</a>.</li>
...
<li>Improved the <code><a class="el" href="namespacepip_1_1__vendor_1_1distlib_1_1__backport_1_1tarfile.html#a86f867d890099d0ed5f0ce9f3a62a368">xhr.open()</a></code> error message when there are not enough arguments. (lencioni)</li>
</ul>
<h2><a class="anchor" id="autotoc_md18963"></a>
9.12.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18971"></a>
9.8.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18980"></a>
9.4.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18982"></a>
9.3.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18983"></a>
9.2.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18984"></a>
9.2.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18985"></a>
9.1.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18986"></a>
9.0.0</h2>
...
<h2><a class="anchor" id="autotoc_md18987"></a>
8.5.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18994"></a>
8.1.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md18998"></a>
8.0.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19000"></a>
7.2.2</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19001"></a>
7.2.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19002"></a>
7.2.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19003"></a>
7.1.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19004"></a>
7.1.0</h2>
...
<h2><a class="anchor" id="autotoc_md19006"></a>
7.0.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19007"></a>
7.0.0</h2>
<p>This major release has as its headlining feature a completely re-written <code>XMLHttpRequest</code> implementation, in a heroic effort by <a href="https://github.com/nicolashenry">@nicolashenry</a>. It includes a number of other smaller improvements and fixes. The breaking changes are highlighted in bold below.</p>
<ul>
...
<li><b>Invalid URLs are no longer allowed when creating a jsdom document</b>; the URL must be parseable, or an error will be thrown.</li>
...
<h2><a class="anchor" id="autotoc_md19008"></a>
6.5.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19009"></a>
6.5.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19010"></a>
6.4.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19011"></a>
6.3.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19013"></a>
6.1.0</h2>
<ul>
...
<li>URL parsing and resolution was entirely overhauled to follow <a href="http://url.spec.whatwg.org/">the URL standard</a>!<ul>
...
<h2><a class="anchor" id="autotoc_md19018"></a>
5.5.0</h2>
<ul>
...
<li>Fixed <code><a class="el" href="namespacepip_1_1__vendor_1_1distlib_1_1__backport_1_1tarfile.html#a86f867d890099d0ed5f0ce9f3a62a368">document.open()</a></code> to return <code>this</code>, per spec. (ryanseddon)</li>
</ul>
...
<h2><a class="anchor" id="autotoc_md19024"></a>
5.2.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19026"></a>
5.0.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19067"></a>
1.0.0-pre.3</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19068"></a>
1.0.0-pre.2</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19069"></a>
1.0.0-pre.1</h2>
...
<h3><a class="anchor" id="autotoc_md19072"></a>
Changed jsdom APIs</h3>
<ul>
...
Removed non-standard DOM APIs</h3>
<ul>
...
<h3><a class="anchor" id="autotoc_md19074"></a>
Other fixes</h3>
<ul>
...
<h2><a class="anchor" id="autotoc_md19075"></a>
0.11.1</h2>
<ul>
...
<li><code>Fix:</code>jsdom.jQueryify` was using the wrong URL for jQuery by default. (lukasbuenger)</li>
</ul>
...
<h2><a class="anchor" id="autotoc_md19077"></a>
0.10.6</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19078"></a>
0.10.5</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19079"></a>
0.10.4</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19081"></a>
0.10.2</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19085"></a>
0.8.11</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19086"></a>
0.8.10</h2>
<ul>
<li>Add: <code>hash</code> property to <code>HTMLAnchorElement</code>. (fr0z3nk0)</li>
</ul>
<h2><a class="anchor" id="autotoc_md19087"></a>
0.8.9</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19089"></a>
0.8.7</h2>
<ul>
<li>Add: <code>host</code> property to <code>HTMLAnchorElement</code>. (sporchia)</li>
</ul>
<h2><a class="anchor" id="autotoc_md19090"></a>
0.8.6</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19094"></a>
0.8.2</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19095"></a>
0.8.1 (hotfix)</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19097"></a>
0.7.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19098"></a>
0.6.5</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19099"></a>
0.6.4</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19102"></a>
0.6.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19103"></a>
0.6.0</h2>
...
<h2><a class="anchor" id="autotoc_md19104"></a>
0.5.7</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19106"></a>
0.5.5</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19107"></a>
0.5.4</h2>
...
<h2><a class="anchor" id="autotoc_md19109"></a>
0.5.2</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19110"></a>
0.5.1</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19111"></a>
0.5.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19113"></a>
0.4.1 (hotfix)</h2>
<ul>
...
<li>Add: support for running the tests using @aredridel's <a href="https://npmjs.org/package/html5">html5</a> parser, as a prelude toward maybe eventually making this the default and fixing various parsing bugs.</li>
</ul>
...
<h2><a class="anchor" id="autotoc_md19119"></a>
0.3.0</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19121"></a>
0.2.18</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19125"></a>
0.2.14</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19129"></a>
0.2.10</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19131"></a>
0.2.8 (hotfix)</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19133"></a>
0.2.6</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19134"></a>
0.2.5</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19135"></a>
0.2.4</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19136"></a>
0.2.3</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19137"></a>
0.2.2</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md19138"></a>
0.2.1</h2>
<ul>
...
<li>The first parameter download is now the object returned by <a class="el" href="namespacepackaging_1_1version.html#a9ac4c2515e799003b63bd7dae516b0b3">URL.parse()</a>. (Robin)</li>

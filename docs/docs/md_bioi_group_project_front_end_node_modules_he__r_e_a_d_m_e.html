...
<title>Vaccine Dashboard: he &lt;a href=&quot;https://travis-ci.org/mathiasbynens/he&quot;&gt;&lt;img src=&quot;https://travis-ci.org/mathiasbynens/he.svg?branch=master&quot; alt=&quot;Build status&quot;/&gt;&lt;/a&gt; &lt;a href=&quot;https://codecov.io/github/mathiasbynens/he?branch=master&quot;&gt;&lt;img src=&quot;https://codecov.io/github/mathiasbynens/he/coverage.svg?branch=master&quot; alt=&quot;Code coverage status&quot;/&gt;&lt;/a&gt; &lt;a href=&quot;https://gemnasium.com/mathiasbynens/he&quot;&gt;&lt;img src=&quot;https://gemnasium.com/mathiasbynens/he.svg&quot; alt=&quot;Dependency status&quot;/&gt;&lt;/a&gt;</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_he__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<p>The default value for the <code>useNamedReferences</code> option is <code>false</code>. This means that <code><a class="el" href="namespacejwt_1_1api__jws.html#a2de060f751c6a434697540cf239d58b3">encode()</a></code> will not use any named character references (e.g. <code>&copy;</code>) in the output — hexadecimal escapes (e.g. <code>&amp;#xA9;</code>) will be used instead. Set it to <code>true</code> to enable the use of named references.</p>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md12827"></a>
&lt;tt&gt;decimal&lt;/tt&gt;</h3>
...
<div class="line">});</div>
<div class="line">// → &#39;&amp;#x66;&amp;#x6F;&amp;#x6F;&amp;#x20;&amp;copy;&amp;#x20;&amp;#x62;&amp;#x61;&amp;#x72;&amp;#x20;&amp;ne;&amp;#x20;&amp;#x62;&amp;#x61;&amp;#x7A;&amp;#x20;&amp;#x1D306;&amp;#x20;&amp;#x71;&amp;#x75;&amp;#x78;&#39;</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md12829"></a>
&lt;tt&gt;strict&lt;/tt&gt;</h3>
<p>The default value for the <code>strict</code> option is <code>false</code>. This means that <code><a class="el" href="namespacejwt_1_1api__jws.html#a2de060f751c6a434697540cf239d58b3">encode()</a></code> will encode any HTML text content you feed it, even if it contains any symbols that cause <a href="https://html.spec.whatwg.org/multipage/parsing.html#preprocessing-the-input-stream">parse errors</a>. To throw an error when such invalid HTML is encountered, set the <code>strict</code> option to <code>true</code>. This option makes it possible to use <em>he</em> as part of HTML parsers and HTML validators.</p>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md12830"></a>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md12831"></a>
...
<div class="line">he.encode(&#39;foo © bar ≠ baz 𝌆 qux&#39;);</div>
<div class="line">// → &#39;foo &amp;copy; bar &amp;ne; baz &amp;#x1D306; qux&#39;</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12832"></a>
...
<p>The default value for the <code>isAttributeValue</code> option is <code>false</code>. This means that <code><a class="el" href="namespacejwt_1_1api__jws.html#a4e689878c0294ef5105ff80ae99fe8f1">decode()</a></code> will decode the string as if it were used in <a href="https://html.spec.whatwg.org/multipage/syntax.html#data-state">a text context in an HTML document</a>. HTML has different rules for <a href="https://html.spec.whatwg.org/multipage/syntax.html#character-reference-in-attribute-value-state">parsing character references in attribute values</a> — set this option to <code>true</code> to treat the input string as if it were used as an attribute value.</p>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md12834"></a>
&lt;tt&gt;strict&lt;/tt&gt;</h3>
<p>The default value for the <code>strict</code> option is <code>false</code>. This means that <code><a class="el" href="namespacejwt_1_1api__jws.html#a4e689878c0294ef5105ff80ae99fe8f1">decode()</a></code> will decode any HTML text content you feed it, even if it contains any entities that cause <a href="https://html.spec.whatwg.org/multipage/syntax.html#tokenizing-character-references">parse errors</a>. To throw an error when such invalid HTML is encountered, set the <code>strict</code> option to <code>true</code>. This option makes it possible to use <em>he</em> as part of HTML parsers and HTML validators.</p>
<div class="fragment"><div class="line">// Using the global default setting (defaults to `false`, i.e. error-tolerant mode):</div>
<div class="line">he.decode(&#39;foo&amp;ampbar&#39;);</div>
<div class="line">// → &#39;foo&amp;bar&#39;</div>
<div class="line"> </div>
...
<div class="line">});</div>
<div class="line">// → Parse error</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md12835"></a>
...
<div class="line">he.decode(&#39;foo&amp;ampbar&#39;);</div>
<div class="line">// → &#39;foo&amp;ampbar&#39;</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12836"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md12837"></a>

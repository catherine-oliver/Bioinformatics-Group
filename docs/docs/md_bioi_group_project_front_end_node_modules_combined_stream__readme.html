...
<title>Vaccine Dashboard: combined-stream</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_combined_stream__readme.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="line"> </div>
<div class="line">combinedStream.pipe(fs.createWriteStream(&#39;combined.txt&#39;));</div>
</div><!-- fragment --><p>However, what if you don't have all the source streams yet, or you don't want to allocate the resources (file descriptors, memory, etc.) for them right away? Well, in that case you can simply provide a callback that supplies the stream by calling a <code><a class="el" href="namespacepip_1_1__vendor_1_1six.html#a35d162c68897d3b3b0c8c06e96cde541">next()</a></code> function:</p>
<div class="fragment"><div class="line">var CombinedStream = require(&#39;combined-stream&#39;);</div>
<div class="line">var fs = require(&#39;fs&#39;);</div>
<div class="line"> </div>
<div class="line">var combinedStream = CombinedStream.create();</div>
...
<div class="line"> </div>
<div class="line">combinedStream.pipe(fs.createWriteStream(&#39;combined.txt&#39;));</div>
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md7272"></a>
API</h1>
...
<p>Whether to apply back pressure to the underlaying streams. If set to <code>false</code>, the underlaying streams will never be paused. If set to <code>true</code>, the underlaying streams will be paused right after being appended, as well as when <code><a class="el" href="namespaceattr_1_1__make.html#a82ef7b8b1b1f5d7ddbd625c3b7d2ada9">delayedStream.pipe()</a></code> wants to throttle.</p>
...
<h2><a class="anchor" id="autotoc_md7278"></a>
...
<p>Same as <code><a class="el" href="namespacepackaging_1_1__musllinux.html#aad969733a57fc63ae5dcb5526c2db626">combinedStream.end()</a></code>, except it emits a &lsquo;'close&rsquo;<code>event instead of </code>'end'`.</p>

...
<title>Vaccine Dashboard: jsdom Changelog</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_jest_environment_jsdom_node_modules_jsdom__changelog.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="title">jsdom Changelog </div>  </div>
</div><!--header-->
<div class="contents">
<div class="textblock"><h1><a class="anchor" id="autotoc_md16840"></a>
16.6.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16842"></a>
16.5.2</h1>
<ul>
...
<li>Fixed <code>new <a class="el" href="namespacetyping__extensions.html#a949e2f32aaee2a039195040d1b50cf41">Text()</a></code> and <code>new Comment()</code> constructors to properly set the resulting node's <code>ownerDocument</code>.</li>
...
<h1><a class="anchor" id="autotoc_md16843"></a>
16.5.1</h1>
<ul>
<li>Fixed a regression that broke <code><a class="el" href="namespacedotenv_1_1cli.html#aaa27b896ba6c8cb56b53bc930fb1b429">customElements.get()</a></code> in v16.5.0. (fdesforges)</li>
...
<h1><a class="anchor" id="autotoc_md16846"></a>
16.3.0</h1>
<ul>
...
16.2.0</h1>
<ul>
<li>Added support for custom elements! Congratulations and thanks to <a href="https://github.com/jsdom/jsdom/commits?author=pmdartus">@pmdartus</a> for making this happen, after ten months of hard work and lots of effort poured into the complex architectural prerequisites in jsdom and supporting packages.</li>
...
<h1><a class="anchor" id="autotoc_md16850"></a>
16.1.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16853"></a>
15.2.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16855"></a>
15.1.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16856"></a>
15.1.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16859"></a>
14.0.0</h1>
<p>Breaking changes:</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md16863"></a>
12.2.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16874"></a>
11.6.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16876"></a>
11.4.0</h1>
<p>For this release we'd like to welcome <a href="https://github.com/jsdom/jsdom/commits?author=Zirro">@Zirro</a> to the core team; his contributions over the course of this year have enhanced jsdom immensely.</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md16877"></a>
11.3.0</h1>
<p>For this release we'd like to formally welcome <a href="https://github.com/jsdom/jsdom/commits?author=TimothyGu">@TimothyGu</a> to the core team, as a prolific contributor. He will join the illustrious ranks of those who do so much work on jsdom that we no longer note their names in the changelog.</p>
<ul>
...
<h1><a class="anchor" id="autotoc_md16881"></a>
10.1.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16882"></a>
10.0.0</h1>
...
<h1><a class="anchor" id="autotoc_md16883"></a>
9.12.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16888"></a>
9.8.3</h1>
<ul>
<li>Fixed syntax errors in Node.js v4.</li>
</ul>
<h1><a class="anchor" id="autotoc_md16889"></a>
9.8.2</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16890"></a>
9.8.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16907"></a>
8.5.0</h1>
<ul>
...
<p>This release also welcomes <a href="https://github.com/jsdom/jsdom/commits/master?author=Joris-van-der-Wel">long-time contributer</a> <a href="https://github.com/Joris-van-der-Wel/">@Joris-van-der-Wel</a> to the core team. You may recognize him from earlier changelogs. We're very happy to have his help in making jsdom awesome!</p>
<ul>
...
<p>Finally, it's worth noting that we now delegate our cookie handling in general to the <a href="https://www.npmjs.com/package/tough-cookie">tough-cookie</a> package, which should hopefully mean that it now captures many of the behaviors that were previously missing (for example <a href="https://github.com/jsdom/jsdom/issues/1027">#1027</a>). @inikulin is working on <a href="https://github.com/goinstant/tough-cookie/pull/30">a large pull request to fix tough-cookie to be more spec compliant</a>, which should automatically be picked up by jsdom installs once it is merged.</p>
...
<h1><a class="anchor" id="autotoc_md16968"></a>
1.5.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16969"></a>
1.4.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16972"></a>
1.3.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16973"></a>
1.3.0</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16975"></a>
1.2.2</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16976"></a>
1.2.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16986"></a>
1.0.0-pre.4</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md16988"></a>
1.0.0-pre.2</h1>
<ul>
...
<h2><a class="anchor" id="autotoc_md16993"></a>
Removed non-standard DOM APIs</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md16994"></a>
Other fixes</h2>
<ul>
...
<h1><a class="anchor" id="autotoc_md16997"></a>
0.10.6</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md17026"></a>
0.5.5</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md17028"></a>
0.5.3</h1>
...
<h1><a class="anchor" id="autotoc_md17030"></a>
0.5.1</h1>
<ul>
...
<h1><a class="anchor" id="autotoc_md17031"></a>
0.5.0</h1>
<ul>

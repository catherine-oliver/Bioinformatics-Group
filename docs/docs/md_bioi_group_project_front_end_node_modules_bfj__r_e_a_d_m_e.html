...
<title>Vaccine Dashboard: BFJ</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_bfj__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h2><a class="anchor" id="autotoc_md4798"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md4804"></a>
...
<p><a class="el" href="md_bioi_group_project_front_end_node_modules_bfj__h_i_s_t_o_r_y.html">Yes</a>.</p>
...
<p>As of <a href="HISTORY.md#300">version <code>3.0.0</code></a>, only Node.js versions 6 or greater are supported because of the dependency on <a href="https://gitlab.com/philbooth/hoopy">Hoopy</a>. Previous versions supported node 4 and later.</p>
<p>A separate <code>node-4</code> branch was maintained until version <code>5.4.1</code>, which had feature parity version-for-version with releases from <code>master</code>. Releases from the <code>node-4</code> branch are available in npm under the package name <a href="https://www.npmjs.com/package/bfj-node4"><code>bfj-node4</code></a>.</p>

...
<title>Vaccine Dashboard: Tmp</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_tmp__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md29534"></a>
Usage</h1>
<p>Please also check <a href="https://raszi.github.io/node-tmp/">API docs</a>.</p>
<h2><a class="anchor" id="autotoc_md29535"></a>
...
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29536"></a>
...
<h2><a class="anchor" id="autotoc_md29537"></a>
...
<h2><a class="anchor" id="autotoc_md29538"></a>
...
<h2><a class="anchor" id="autotoc_md29539"></a>
...
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29540"></a>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md29541"></a>
Advanced usage</h1>
<h2><a class="anchor" id="autotoc_md29542"></a>
Asynchronous file creation</h2>
...
<div class="line">  console.log(&#39;Filedescriptor: &#39;, fd);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29543"></a>
Synchronous file creation</h2>
<p>A synchronous version of the above.</p>
<div class="fragment"><div class="line">var tmp = require(&#39;tmp&#39;);</div>
<div class="line"> </div>
...
<div class="line">console.log(&#39;File: &#39;, tmpobj.name);</div>
<div class="line">console.log(&#39;Filedescriptor: &#39;, tmpobj.fd);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29544"></a>
...
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29545"></a>
Asynchronous directory creation</h2>
...
<div class="line">  console.log(&#39;Dir: &#39;, path);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29546"></a>
Synchronous directory creation</h2>
...
<div class="line">console.log(&#39;Dir: &#39;, tmpobj.name);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29547"></a>
...
<div class="line">  console.log(&#39;Dir: &#39;, path);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29548"></a>
...
<div class="line">console.log(&#39;Dir: &#39;, tmpobj.name);</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29549"></a>
Asynchronous filename generation</h2>
...
<div class="line">    console.log(&#39;Created temporary filename: &#39;, path);</div>
<div class="line">});</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md29550"></a>
Synchronous filename generation</h2>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md29551"></a>
Graceful cleanup</h1>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md29552"></a>
Options</h1>

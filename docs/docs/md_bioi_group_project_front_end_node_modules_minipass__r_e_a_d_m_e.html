...
<title>Vaccine Dashboard: minipass</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_minipass__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<p>Supports <a class="el" href="namespaceattr_1_1__make.html#a82ef7b8b1b1f5d7ddbd625c3b7d2ada9">pipe()</a>ing (including multi-pipe() and backpressure transmission), buffering data until either a <code>data</code> event handler or <code><a class="el" href="namespaceattr_1_1__make.html#a82ef7b8b1b1f5d7ddbd625c3b7d2ada9">pipe()</a></code> is added (so you don't lose the first chunk), and most other cases where PassThrough is a good idea.</p>
<p>There is a <code>read()</code> method, but it's much more efficient to consume data from this stream via &lsquo;'data&rsquo;<code>events or by calling</code><a class="el" href="namespaceattr_1_1__make.html#a82ef7b8b1b1f5d7ddbd625c3b7d2ada9">pipe()</a><code>into some other stream. Calling</code>read()` requires the buffer to be flattened in some cases, which requires copying memory.</p>
...
<p>If a stream is not paused, and <code><a class="el" href="namespacepackaging_1_1__musllinux.html#aad969733a57fc63ae5dcb5526c2db626">end()</a></code> is called before writing any data into it, then it will emit <code>end</code> immediately.</p>
<p>If you have logic that occurs on the <code>end</code> event which you don't want to potentially happen immediately (for example, closing file descriptors, moving on to the next entry in an archive parse stream, etc.) then be sure to call <code><a class="el" href="namespaceclick_1_1termui.html#a4229b4017590eb5acb7f2722d086e58a">stream.pause()</a></code> on creation, and then <code>stream.resume()</code> once you are ready to respond to the <code>end</code> event.</p>
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md20751"></a>
USAGE</h1>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20752"></a>
OPTIONS</h2>
<ul>
...
<h2><a class="anchor" id="autotoc_md20754"></a>
Methods</h2>
<ul>
...
<li><code><a class="el" href="namespaceclick_1_1termui.html#a4229b4017590eb5acb7f2722d086e58a">pause()</a></code> - No more data for a while, please. This also prevents <code>end</code> from being emitted for empty streams until the stream is resumed.</li>
...
<li><code><a class="el" href="namespacejinja2_1_1utils.html#afc9da5e9327cf4c3db6e7c18e8d9bb45">concat()</a></code> - Same as <code>collect()</code>, but concatenates the data into a single Buffer object. Will reject the returned promise if the stream is in objectMode, or if it goes into objectMode by the end of the data.</li>
...
<li><code>writable</code> Whether the stream is writable. Default <code>true</code>. Set to <code>false</code> when <code><a class="el" href="namespacepackaging_1_1__musllinux.html#aad969733a57fc63ae5dcb5526c2db626">end()</a></code></li>
...
<li><code>end</code> Emitted when there's no more data to read. This will be emitted immediately for empty streams when <code><a class="el" href="namespacepackaging_1_1__musllinux.html#aad969733a57fc63ae5dcb5526c2db626">end()</a></code> is called. If a listener is attached, and <code>end</code> was already emitted, then it will be emitted again. All listeners are removed when <code>end</code> is emitted.</li>
...
Static Methods</h2>
<ul>
<li><code>Minipass.isStream(stream)</code> Returns <code>true</code> if the argument is a stream, and false otherwise. To be considered a stream, the object must be either an instance of Minipass, or an EventEmitter that has either a <code><a class="el" href="namespaceattr_1_1__make.html#a82ef7b8b1b1f5d7ddbd625c3b7d2ada9">pipe()</a></code> method, or both <code>write()</code> and <code><a class="el" href="namespacepackaging_1_1__musllinux.html#aad969733a57fc63ae5dcb5526c2db626">end()</a></code> methods. (Pretty much any stream in node-land will return <code>true</code> for this.)</li>
</ul>
...
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20761"></a>
...
<div class="line">})</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20762"></a>
iteration</h2>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20763"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20764"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20765"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20766"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md20767"></a>

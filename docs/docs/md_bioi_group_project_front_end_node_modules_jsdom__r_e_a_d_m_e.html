...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md_bioi_group_project_front_end_node_modules_jsdom__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<h3><a class="anchor" id="autotoc_md19357"></a>
Simple options</h3>
...
<div class="fragment"><div class="line">const window = (new JSDOM(``, { runScripts: &quot;outside-only&quot; })).window;</div>
<div class="line"> </div>
...
<h3><a class="anchor" id="autotoc_md19360"></a>
Loading subresources</h3>
<h4><a class="anchor" id="autotoc_md19361"></a>
Basic options</h4>
...
<h4><a class="anchor" id="autotoc_md19362"></a>
...
<div class="line">  }</div>
<div class="line">}</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md19363"></a>
Virtual consoles</h3>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md19364"></a>
Cookie jars</h3>
...
<h3><a class="anchor" id="autotoc_md19365"></a>
...
<h2><a class="anchor" id="autotoc_md19366"></a>
...
<h3><a class="anchor" id="autotoc_md19367"></a>
Properties</h3>
...
<p>The <code><a class="el" href="namespacepip_1_1__vendor_1_1html5lib_1_1serializer.html#aa7fa7300047147b215d8b1f35cc19a25">serialize()</a></code> method will return the <a href="https://html.spec.whatwg.org/#html-fragment-serialisation-algorithm">HTML serialization</a> of the document, including the doctype:</p>
...
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md19369"></a>
...
Running vm-created scripts with &lt;tt&gt;runVMScript(script[, options])&lt;/tt&gt;</h3>
...
<div class="line">const s = new Script(`</div>
...
<div class="line">`);</div>
<div class="line"> </div>
<div class="line">dom.runVMScript(s);</div>
<div class="line">dom.runVMScript(s);</div>
<div class="line">dom.runVMScript(s);</div>
<div class="line"> </div>
<div class="line">dom.window.ran === 3;</div>
...
<p><code>runVMScript()</code> also takes an <code>options</code> object as its second argument. See the <a href="https://nodejs.org/api/vm.html#vm_script_runincontext_contextifiedsandbox_options">Node.js docs</a> for details. (This functionality does not work when [using jsdom in a web browser](running-jsdom-inside-a-web-browser).)</p>
<h3><a class="anchor" id="autotoc_md19371"></a>
...
<h2><a class="anchor" id="autotoc_md19372"></a>
Convenience APIs</h2>
...
<h3><a class="anchor" id="autotoc_md19374"></a>
&lt;tt&gt;fromFile()&lt;/tt&gt;</h3>
...
<h3><a class="anchor" id="autotoc_md19375"></a>
&lt;tt&gt;fragment()&lt;/tt&gt;</h3>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md19376"></a>
Other noteworthy features</h2>
<h3><a class="anchor" id="autotoc_md19377"></a>
Canvas support</h3>
...
<h3><a class="anchor" id="autotoc_md19379"></a>
...
<h3><a class="anchor" id="autotoc_md19381"></a>
...
<h2><a class="anchor" id="autotoc_md19382"></a>
Caveats</h2>
...
<h3><a class="anchor" id="autotoc_md19384"></a>
Shared constructors and prototypes</h3>
...
<div class="fragment"><div class="line">const dom1 = new JSDOM();</div>
<div class="line">const dom2 = new JSDOM();</div>
<div class="line"> </div>
<div class="line">dom1.window.Element.prototype.expando = &quot;blah&quot;;</div>
<div class="line">console.log(dom2.window.document.createElement(&quot;frameset&quot;).expando); // logs &quot;blah&quot;</div>
</div><!-- fragment --><p>This is done mainly for performance and memory reasons: creating separate copies of all the many classes on the web platform, each time we create a jsdom, would be rather expensive.</p>
...
<h2><a class="anchor" id="autotoc_md19386"></a>
Supporting jsdom</h2>
